        ...
        <div className=' h-full w-full flex justify-center items-center'>
            <div className=' md:w-[70%] xl:w-[80%] lg:w-[98%] flex flex-col justify-evenly gap-5 md:gap-10 md:justify-around h-full items-center text-black'>
                ...
                <div className='card  h-52 w-80 relative px-5 rounded-md bg-black-100 bg-opacity-20  border -500 border-2  flex flex-col justify-evenly '>
                  ...
                  <div className=' w-full flex flex-col'>
                    <p className='  font-inter-bold text-white'>System Integration</p>
                    <p className=' size font-gilroy text-white  '><br /> Our Software integration engineers adopt <br />next-gen technologies and process to <br /> streamline and integrate everything from <br /> design, development, and testing to execution.</p>
                  </div>
                </div>
              </div>
            </div>
