...
const Abouts = () => {
  return (
    <div className=' bg-abouts bg-bottom bg-cover bg-no-repeat xl:h-[982px] h-screen w-full'>
        <div className=' h-screen w-full flex items-center justify-center'> 
          <div className=' flex items-center h-screen w-[80%]'>
            <div className=' flex flex-col text-black gap-10 w-[650px] '>
              ...
              <button className=' bg-white font-gilroy-semi-bold lg:text-[20px] w-max rounded-full py-2 lg:py-[10px] px-5 border-black border-[2px] shadow-sm shadow-black relative top-2 left-2 z-10'>Read more</button>
              <button className=' bg-white font-gilroy-semi-bold lg:text-[20px] w-max rounded-full py-2 lg:py-[10px] px-5 border-purple-400 border-[2px] relative bottom-20 left-3'>Read more</button>
