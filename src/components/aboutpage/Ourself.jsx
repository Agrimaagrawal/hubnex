...
const Ourself = () => {
  return (
    <div className=" h-auto md:py-0 py-24 lg:h-[1024px] w-full bg-earth bg-contain bg-bottom bg-black bg-no-repeat">
        <div className=' h-full w-full flex justify-center '>
            <div className=' w-[80%] flex justify-between '>
                
                <div className=' w-full flex flex-col gap-20 text-white   '> 
                   <div className=' w-90 flex flex-col gap-8 text-center md:mt-40 '>
                    <span className=' text-4xl lg:text-[65px] font-gilroy-semi-bold '>Who We Are</span>
                    <p className='text-center font-gilroy-medium lg:text-[24px]'>Our values shape the culture of our organization and define who we are. These are at the core<br></br> of how we work and what we do. We are:</p>
                   </div>
